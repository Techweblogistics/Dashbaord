		...
		<div class="p-11 pb-24 border rounded-[50px] bg-contain bg-center bg-no-repeat max-sm:px-5" style="background-image: url(/assets/img/site/world-map.png)">
			...
			<div class="max-lg:11/12 max-md:w-full w-8/12 mx-auto">
				...
				<div class="opacity-80 max-lg:gap-12 max-sm:gap-4 flex justify-center gap-20">
                    ...
                    @if($entry->title == "Crunchbase")
                    <a href="https://www.crunchbase.com/organization/ai-spartanz" target="_blank"><img class="object-cover object-center w-full h-full" style="max-width: 48px; max-height: 48px;" src="{{isset($entry->avatar) ? (str_starts_with($entry->avatar, 'asset') ? url('').'/'.$entry->avatar : url('').'/clientAvatar/'.$entry->avatar ) : url('').'/assets/img/auth/default-avatar.png'}}" alt="{{__($entry->alt)}}" title="{{__($entry->title)}}"></a>
                    @elseif($entry->title == "F6s.com")
                    <a href="https://www.f6s.com/company/ai-spartanz" target="_blank"><img class="object-cover object-center w-full h-full" style="max-width: 48px; max-height: 48px;" src="{{isset($entry->avatar) ? (str_starts_with($entry->avatar, 'asset') ? url('').'/'.$entry->avatar : url('').'/clientAvatar/'.$entry->avatar ) : url('').'/assets/img/auth/default-avatar.png'}}" alt="{{__($entry->alt)}}" title="{{__($entry->title)}}"></a>
                    <a href="#" target="_blank"><img class="object-cover object-center w-full h-full" style="max-width: 48px; max-height: 48px;" src="{{isset($entry->avatar) ? (str_starts_with($entry->avatar, 'asset') ? url('').'/'.$entry->avatar : url('').'/clientAvatar/'.$entry->avatar ) : url('').'/assets/img/auth/default-avatar.png'}}" alt="{{__($entry->alt)}}" title="{{__($entry->title)}}"></a>
                    @endif
                    @endforeach
                </div>
			</div>
